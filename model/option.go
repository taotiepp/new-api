...
func InitOptionMap() {
	...
	common.OptionMap["UserModelRateLimitConfig"] = setting.UserModelRateLimitConfig2JSONString()
...
func validateOptionValue(key string, value string) error {
	...
	if key == setting.UserModelRateLimitOptionKey() {
		return setting.ValidateUserModelRateLimitConfig(value)
	}
	return nil
}
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "UserModelRateLimitConfig":
		err = setting.UpdateUserModelRateLimitConfigByJSONString(value)
	case "RetryTimes":
